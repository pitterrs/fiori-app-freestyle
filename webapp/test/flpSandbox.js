		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdeeresfutsupplierappv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdeeresfutsupplierappv2-display": {
								"semanticObject": "comdeeresfutsupplierappv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.deere.sfut.supplierappv2",
									"url": sap.ui.require.toUrl("com/deere/sfut/supplierappv2")
								}
							}
						}
					}
